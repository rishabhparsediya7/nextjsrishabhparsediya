...
export const HoverEffect = ({
    ...
    return (
        <div
            className={cn(
                "grid p-10 grid-cols-1 sm:grid-cols-2  md:grid-cols-3",
                className
            )}
        >
            {items.map((item, idx) => (
                ...
                >
                    ...
                    <Card>
                        ...
                        <CardFooter technologies={item.technology_used} />
                    </Card>
                </Link>
            ))}
        </div>
...
export const CardFooter = ({
    ...
    return (
        ...
        >
            {technologies.map((tech) => <p className="bg-slate-800 rounded-md p-1" key={tech}>{tech}</p>)}
        </div>
    );
};
