...
export default function SpotifyPlayer() {
  ...
  return (
    <div className="w-full flex items-start justify-between px-32 py-10">
      <div className="w-full min-w-3xl bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:to-black rounded-xl shadow-xl overflow-hidden">
        <div className="px-6 py-5 border-b border-gray-200 dark:border-gray-800 flex items-center justify-between">
          <h1 className="text-2xl font-bold bg-gradient-to-r from-pink-500 to-red-500 bg-clip-text text-transparent">
            Music
          </h1>
          ...
          <div className="mx-6 mt-4 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 text-red-700 dark:text-red-400 px-4 py-3 rounded-lg text-sm">
            ...
            {error.includes("Premium") && (
              <p className="mt-2 text-xs opacity-80">
                Note: Spotify Web Playback SDK requires a Spotify Premium
                account.
              </p>
            )}
          </div>
        ...
        {isAutoConnecting ? (
          ...
          <div className="p-6">
            <div className="mb-8">
              {deviceId && <NowPlaying token={token} />}
            </div>
      ...
      <div className="w-full max-w-xl px-10 space-y-4">
        <div>
          <p className="text-xl text-gray-500 dark:text-gray-100 font-bold">
            Want to soothen your soul?
          </p>
          <p className="text-gray-500 dark:text-gray-400">
            Listen to my favorite songs and see if you like them too!
          </p>
        </div>
        <p
        ...
        >
          Amidst the lines of code and the hum of machines, I find solace in the
          melodies of <strong>Bollywood romantic music</strong>. Each lyric,
          each note, carries emotions that words often fail to express—love,
          longing, nostalgia, and the quiet whispers of the heart. Music, like
          code, is an art—one that connects souls, tells untold stories, and
          reminds us of what it truly means to feel. In a world driven by logic,
          these songs bring warmth, passion, and a touch of poetry to life,
          setting us apart in our <strong> beautifully human</strong> ways. 🎶❤️
        </p>
      </div>
    </div>
  );
